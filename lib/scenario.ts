...
export const SCENARIO: ScenarioStep[] = [
  ...
  {
    caption: "Amicia proposes the terms: $2,400 over six payments, two reminders a month, a 21-day cure period.",
  ...
  {
    caption: "Proposing registered an answer on Hugo. He accepts.",
    action: "accept-terms",
    role: "borrower",
    holdMs: 2600,
  },
  {
    caption: "Amicia signs her half. Nobody can sign for the other party.",
    action: "sign-agreement",
    role: "lender",
    holdMs: 2400,
  },
  {
    caption: "Hugo signs his. Both halves signed, so the schedule starts and the payment tools register.",
    action: "sign-agreement",
    role: "borrower",
    holdMs: 3200,
  },
  ...
  {
    caption: "Hugo logs his first payment. Logging it registers a confirmation duty on Amicia.",
    action: "log-payment",
    role: "borrower",
  ...
  {
    caption: "Amicia confirms it landed. Until she does, it does not touch the balance.",
  ...
  {
    caption: "Amicia sends a reminder. One left this month.",
  ...
  {
    caption: "Hugo asks for fourteen more days. The ask registers grant and decline on Amicia — it cannot be ignored into silence.",
  ...
  {
    caption: "Amicia tries to declare default. Refused: the cure period has not run and there is an unanswered request.",
  ...
  {
    caption: "Weeks later Hugo is behind again, and takes the hardship pause that is his once a year.",
    action: "advance-clock",
    role: "lender",
    payload: { days: 40 },
    holdMs: 2400,
  ...
  {
    caption: "The pause runs without asking permission, and it takes Amicia's reminder and default tools off the board while it lasts.",
